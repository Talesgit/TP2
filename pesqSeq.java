...
class Jogador {
    ...
    public void setAll(String id, String player, String altura, String peso, String college, String born, String bCity,
        ...
        set_bCity(bCity);
        set_bState(bState);
    } // metodo criado para ser chamado no construtor para inicializar os atributos, pois nos metodos set esta sendo verificado se as strings estao vazias
    ...
    // todos os setters verificam se a string esta vazia por seguranca
    ...
    public void ler(int idPin) {
        ...
        try {
            ...
            do {
                ...
                setAll(Integer.toString(idPin), nome, altura, peso, college, nasc, cNasc, sNasc); // funcao setAll para
                                                                                                  // setar todos os
                                                                                                  // atributos para a
                                                                                                  // instancia atual, a
                                                                                                  // fim de imprimir
...
class pesqSeq extends Jogador {
    public static void main(String[] args) {
        pesqSeq obj = new pesqSeq();
        String[] jogadores = new String[3923];
        String id = "";
        int c = 0; // indicar posicao no vetor
        id = MyIO.readLine();
        while (!id.equals("FIM")) {
            obj.ler(Integer.valueOf(id));
            jogadores[c] = obj.get_player();
            c++;
            id = MyIO.readLine();
        }

        // pesq sequencial no vetor
        String nome = "";
        do {
            nome = MyIO.readLine();
            int verify = 0;
            ...
            } // fim if que verifica se o nome esta presente
        } while (!nome.equals("FIM")); // fim while
    } // fim main
} // fim class
